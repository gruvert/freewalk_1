...
async def register(resto_data: User):
    ...
    Rest_DB.add_user(resto_data.name, resto_data.short_description, resto_data.adress, resto_data.count_places, resto_data.email, resto_data.password)
...
async def login(resto_data: User):
    ...
    if restaurant is None or restaurant.password != resto_data.password:
